  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        style: ButtonStyle(
            elevation: MaterialStatePropertyAll(this.elevation),
            backgroundColor:
                MaterialStatePropertyAll<Color>(color ?? Color(0xFF000000)),
            foregroundColor: MaterialStatePropertyAll<Color>(_textColor!)),
        onPressed: () async {
